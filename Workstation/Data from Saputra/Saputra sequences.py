...
filepath = r'D:\AESB\AESB3\BEP\Figures\01 - Saputra Data'
res = 5
n = 4
# Run the data through the Burgess model:
result1_1, result2_1 = burg.main(depths1, lith1, layout, res, n, filepath=filepath + r'\Log 1')
result1_2, result2_2 = burg.main(depths2, lith2, layout, res, n, filepath=filepath + r'\Log 2')
result1_3, result2_3 = burg.main(depths3, lith3, layout, res, n, filepath=filepath + r'\Log 3')
